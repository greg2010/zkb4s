...
import org.red.zkb4s.schema.StatsSchema.SuperPilot
...
class StatsSpec extends FlatSpec with MustMatchers {
  ...
  "alliance stats" should "be parsed" in {
    ...
    val r           = decode[StatsSchema.AllianceInfo](json).right.get
  ...
  "alliance stats 2" should "be parsed" in {
    ...
    val r    = decode[StatsSchema.AllianceInfo](json)
    println(r)
    val r2          = r.right.get
  ...
  "character stats 1" should "be parsed" in {
    ...
    val r           = decode[StatsSchema.CharacterInfo](json)
  ...
  "corporation stats 1" should "be parsed" in {
    ...
    val r = decode[StatsSchema.CorporationInfo](json)
    r.isRight must equal(true)
